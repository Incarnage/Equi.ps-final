...
class SignupForm extends StatelessWidget {
  ...
  () => DropdownButtonFormField<String>(
    ...
    items: const [
      DropdownMenuItem(
        value: 'Lessee', // The actual value that will be stored
        child: Text(
          "I want to rent properties", // Displayed text for the user
          style: TextStyle(
          ...
          shape: const RoundedRectangleBorder(
            ...
            side: BorderSide(
              ...
              width: 1,
                  ...
                  // QR Code Upload Section (Visible only for 'Lessor')
                  Obx(
                    () => controller.userType.value == 'Lessor'
                        ? Column(
