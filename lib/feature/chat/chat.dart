...
class _ChatRoomState extends State<ChatRoom> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [Expanded(child: _buildMessageList()), _buildUserMessage()],
      ),
    );
  }
  ...
  Widget _buildMessageList() {
    ...
    return StreamBuilder(
        stream: _chatcontroller.getMessage(widget.receiverID, senderID),
  ...
  Widget _buildMessageItem(DocumentSnapshot doc) {
    ...
    bool isCurrentUser =
        data['senderID'] == UserController.instance.user.value.id;
        ...
        children: [
          ...
          Container(
              ...
              decoration: const BoxDecoration(
                  color: Color(0xFF25291C), shape: BoxShape.circle),
              child: IconButton(
